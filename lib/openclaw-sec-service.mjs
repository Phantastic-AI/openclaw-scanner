...
export const DEFAULT_OPENCLAW_SEC_LOG_PATH = "/var/log/openclaw-sec/scans.jsonl";
...
export function normalizeOpenclawSecConfig(raw = {}) {
  ...
  return {
    ...
    logPath: String(raw.logPath || "").trim() || DEFAULT_OPENCLAW_SEC_LOG_PATH,
...
export function createOpenclawSecHandlers(config) {
  return {
    async status() {
